    ...
    public function getCurrency($token, $orderId, $getAddress = false)
    {
        ...
        if ($rate) {
            ...
            switch ($token) {
                ...
                case 'DASH':
                    $currency = (object) [
                        ...
                        'blockExplorer' => 'https://explorer.dash.org/address/%s',
                        'minimum'       => 0.0005,
                        'min_with_fee'  => 0.003,
                    ];
                    break;
                /*
                          case 'XMR':
                              return (object)[
                                  ...
                                  'blockExplorer' => 'https://moneroblocks.info/tx/%s'
                              ];
                              break;
                          case 'WAVES':
                              return (object)[
                                  ...
                                  'blockExplorer' => 'https://wavesexplorer.com/address/%s'
                              ];
                              break;
                          case 'EOS':
                              return (object)[
                                  ...
                                  'blockExplorer' => 'https://etherscan.io/token/EOS?a=%s'
                              ];
                              break;
                          case 'ETC':
                              return (object)[
                                  ...
                                  'blockExplorer' => 'https://etcchain.com/addr/%s'
                              ];
                              break;
                */
                default:
                    //echo 'currency '.$token.' not found';
                    return null;
            }
            ...
            if ($getAddress) {
                ...
                // $currency->currencyUrl = sprintf('/app_dev.php/currencies?order=%s&token=%s', $orderId, $token);
            }
