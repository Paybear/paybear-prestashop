...
{block name="content"}
    ...
    <div id="paybear" style="display: none" data-currencies="{$currencies}" data-fiat-value="{$fiatValue}"
                ...
                <div class="PayBear">
                    ...
                    <div class="PayBear__Nav">
                        <div>
                            ...
                            <div class="PayBear__Nav__price" style="display: none;">
                                $<span>--</span> USD
                            </div>
                        </div>
                        ...
                        <div class="P-box__inner">
                            ...
                            <div class="P-Payment__start">
                                ...
                                <div class="P-Tabs" id="paybear-tabs">
                                    <ul class="P-Tabs__Tab-list P-Tabs__Tab-list--second">
                                        <li role="tab" class="P-Tabs__Tab">Wallet</li>
                            ...
                            <div class="P-Payment__expired" style="display: none;">
                                <div class="P-Content">
                                    <div class="P-Content__icon">
                                        <img src="data:image/svg+xml;base64,">
                                    </div>
                                    <h2>Payment Window Expired</h2>
                                    <p>
                                        Not to worry, simply go back and start the process
                                        the same way you did before
                                    </p>
                                    <div>
                                        <a href="/" class="P-btn">
                                            <i class="P-btn__icon P-btn__icon--back"></i>
                                            Back to Cart
                                        </a>
                                    </div>
                            ...
                            <div class="P-Payment__confirming" style="display: none;">
                                <div class="P-Content">
                                    ...
                                    <p class="P-confirmations">
                                        ---
                                    </p>
                                    <p>You can freely close this window now!</p>
                                    <div>
                                        <button class="P-btn">
                                            <i class="P-btn__icon P-btn__icon--back"></i>
                                            Back to Cart
